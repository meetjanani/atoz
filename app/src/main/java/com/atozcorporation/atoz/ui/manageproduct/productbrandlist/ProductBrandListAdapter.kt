...
class ProductBrandListAdapter(val iAdapterOnClick: IAdapterOnClick) :
    RecyclerView.Adapter<ProductBrandListAdapter.MyViewHolder>() {

    private var context: Context? = null
    private var arrayList: List<ProductBrandListResponse.ProductBrand> = listOf()
    ...
    fun ProductBrandListAdapter(
        context: Context,
        arrayList: List<ProductBrandListResponse.ProductBrand>,
        string: String?
    ) {
